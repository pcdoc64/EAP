...
$sel=$_GET['sel'];
if ($sel=='branch_edit') {
  echo "<div id='PgTitle'>Edit Branch records</div>";
  $cnti=0;
  ...
  echo "<div id='PgTitle'>New Branch Record</div>";
  $result=FALSE;
}
?>
<div class="centered_form">
 <div id="equipform" class="risk_form">
  <form action="branch_save.php" class="div_form" id="branchform" method="post">
    <?php
     if ($sel=='branch_edit') {
